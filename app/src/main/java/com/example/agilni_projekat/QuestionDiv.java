...
public class QuestionDiv {
    ...
    public QuestionDiv(int upperLimit){
        ...
        this.answerPosition=randomNumberMaker.nextInt(8);
        this.answerArray=new int[] {0,1,2,3,4,5,6,7};

        this.answerArray[0]= answer+4;
        while(this.answerArray[0]>6 || this.answerArray[0]==0){
            this.answerArray[0]--;
        }
        this.answerArray[1]= answer+3;
        while(this.answerArray[1]>6 || this.answerArray[1]==0){
            this.answerArray[1]--;
        }
        this.answerArray[2]= answer+2;
        while(this.answerArray[2]>6 || this.answerArray[2]==0){
            this.answerArray[2]--;
        }
        this.answerArray[3]= answer+1;
        while(this.answerArray[3]>6 || this.answerArray[3]==0){
            this.answerArray[3]--;
        }
        this.answerArray[4]= answer;
        while(this.answerArray[4]>6 || this.answerArray[4]==0){
            this.answerArray[4]--;
        }
        this.answerArray[5]= answer-1;
        while(this.answerArray[5]>6 || this.answerArray[5]==0){
            this.answerArray[5]--;
        }
        this.answerArray[6]= answer-2;
        while(this.answerArray[6]>6 || this.answerArray[6]==0){
            this.answerArray[6]--;
        }
        this.answerArray[7]= answer-3;
        while(this.answerArray[7]>6 || this.answerArray[7]==0){
            this.answerArray[7]++;
        }
